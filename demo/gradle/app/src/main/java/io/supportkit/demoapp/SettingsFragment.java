    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mInit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!appToken.equals("")) {
                    Toast toast = Toast.makeText(getActivity(), "SupportKit re-initialized w/ token '" + appToken + "'.", Toast.LENGTH_LONG);
                    ...
                    // initialized SupportKit from the Application class
                    SupportKit.init(getActivity().getApplication(), appToken);
                }
            }
        });
